...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PYTHIA_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("47b8ac8e-e87e-59c1-8ebd-407ebead3f7c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PYTHIA", artifacts_toml) for e in artifacts["PYTHIA"]]
...
if best_platform === nothing
    @debug("Unable to load PYTHIA; unsupported platform $(triplet(platform_key_abi()))")
else
